...
- Include `Generated by Mistral Vibe. Co-Authored-By: Mistral Vibe <vibe@mistral.ai>`

## Current Focus
- Core gameplay: Timeline component, card placement logic
- Game setup: NewGamePage form flow
- Game play: PlayPage with draw/place mechanics
- API integration: Events and games endpoints
